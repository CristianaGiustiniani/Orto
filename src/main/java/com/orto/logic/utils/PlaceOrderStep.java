...
public enum PlaceOrderStep {
    ...
    public String getStep() {
        return switch (this) {
            ...
            case SHIPPING_SELECTION -> I18n.t("STEP_SHIPPING_SELECTION");
    ...
    public PlaceOrderStep next() throws EndOfEnumException {
        return switch (this) {
            case PRODUCT_SELECTION -> SHIPPING_SELECTION;
            case SHIPPING_SELECTION -> PAYMENT_SELECTION;
    ...
    public PlaceOrderStep previous() throws StartOfEnumException {
        return switch (this) {
            case SHIPPING_SELECTION -> PRODUCT_SELECTION;
            case PAYMENT_SELECTION -> SHIPPING_SELECTION;
